...
public class TelegramHashValidation {
    ...
    public static boolean checkAuth(String botToken, TelegramAuthData telegramAuthData) {
        try {
            User user = telegramAuthData.getUser();
            String hash = telegramAuthData.getHash();
            ...
            fields.put("auth_date", String.valueOf(telegramAuthData.getAuthDate()));
